import{L as Oe,g as o,c as Q,r as xe,a as ee,b as c,d as De,e as Me,f as y,s as f,h as ce,i as _e,j as ue,k as m,l as ve,m as h}from"./utils.540c195c.js";import{K as Ne,L as Ie,O as Se,o as Ge,r as n,q as C,P as $e,a as Xe,c as ze,l as Ye,v as He}from"./vendor.0830267b.js";import{a as Ve}from"./index.b974020a.js";const I=new Oe;I.update_time_step=16;function qe(t){let e;function l(){if(t.value)try{e=dt(t.value),I.linkProgram(e)}catch{}}const{isLandingPage:_,onAfterPageEnter:d}=Ve();Ne(()=>Ie(()=>{I.init(),Se(t,u=>{e&&(I.unlinkProgram(e),e.destroy()),_.value==!0?l():d(l)},{flush:"sync",immediate:!0})})),Ge(()=>{e&&(I.unlinkProgram(e),e.destroy())})}const S=o`
uniform float dt;
uniform float time;
