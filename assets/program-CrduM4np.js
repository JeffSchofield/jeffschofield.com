import{L as Ke,g as a,c as ee,a as Q,b as n,r as Ue,d as Ze,e as Je,f as u,s as f,h as be,i as Fe,j as Re,k as w,l as p,m as pe}from"./utils-B_gNnKp6.js";import{e as i,D as Qe,E as et,g as tt,M as rt,q as D,O as Ae}from"./index-RO_jvqb9.js";const A=new Ke;A.update_time_step=16;function Et(t,{n_fireflies:_=3e4}={}){let e;const l=i(_);function v(){if(t.value)try{console.log("Creating firefly program"),e=Tt(t.value,{n_fireflies:l.value}),A.linkProgram(e),console.log("Firefly program created")}catch(d){console.error(d)}}return Qe(()=>et(()=>{A.init(),tt(t,m=>{e&&(A.unlinkProgram(e),e.destroy()),v()},{flush:"sync",immediate:!0})})),rt(()=>{e&&(A.unlinkProgram(e),e.destroy())}),{setFireflies(d){l.value=d,e&&(e.state.n_particles.value=d,e.init())},pause(){A.cancelLoop()},play(){A.requestLoop()}}}const Y=a`
uniform float dt;
uniform float time;
