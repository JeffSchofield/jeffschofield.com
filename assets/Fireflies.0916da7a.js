import{L as Ke,g as s,c as Z,b as n,a as fe,r as Le,d as Ze,e as Je,f as d,s as u,h as Fe,i as Re,j as Ae,k as v,l as ue,m as h}from"./utils.4d360acf.js";import{v as Qe,x as et,B as tt,A as rt,f as a,g as O,D as Pe,e as ot,o as it,c as at,a as st}from"./index.6f565af3.js";const R=new Ke;R.update_time_step=16;function nt(t){let e;function l(){if(t.value)try{e=Pt(t.value),R.linkProgram(e)}catch{}}return Qe(()=>et(()=>{R.init(),rt(t,f=>{e&&(R.unlinkProgram(e),e.destroy()),l()},{flush:"sync",immediate:!0})})),tt(()=>{e&&(R.unlinkProgram(e),e.destroy())}),{pause(){R.cancelLoop()},play(){R.requestLoop()}}}const Y=s`
uniform float dt;
uniform float time;
