import{L as Ke,g as i,c as J,a as Z,b as n,r as Ue,d as Ze,e as Je,f as v,s as p,h as be,i as Fe,j as Re,k as h,l as u,m as pe}from"./utils-BdnX1zH_.js";import{D as Qe,E as et,g as tt,M as rt,e as s,q as O,O as Ae,p as ot,c as it,o as at,a as st}from"./index-BGIcgW18.js";const R=new Ke;R.update_time_step=16;function nt(t){let e;function l(){if(t.value)try{console.log("Creating firefly program"),e=Et(t.value),R.linkProgram(e),console.log("Firefly program created")}catch(_){console.error(_)}}return Qe(()=>et(()=>{R.init(),tt(t,f=>{e&&(R.unlinkProgram(e),e.destroy()),l()},{flush:"sync",immediate:!0})})),rt(()=>{e&&(R.unlinkProgram(e),e.destroy())}),{pause(){R.cancelLoop()},play(){R.requestLoop()}}}const V=i`
uniform float dt;
uniform float time;
